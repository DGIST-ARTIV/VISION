...
class DetectorManager():
    def __init__(self):
        ...
        # Define publishers
        self.pub_ = rospy.Publisher("/yolov3/bbox", BoundingBoxes, queue_size=0)
        self.pub_viz_ = rospy.Publisher("/yolov3/image_raw", Image, queue_size=0)
...
"""
            ...
            #print("label: %s ,width: %d, height: %d, center:(%d, %d)" %(label, w, h, center[0], center[1]))
