...
def parse_args():
    ...
    parser.add_argument("--video_path", '-i', type=str, default="/media/dgist/ARTIV Backup/2019 yolo dataset/autonomous_car/dataset final/dataset/08 before/kkh1.mp4", help="Path to demo video")
...
def affine_trasform(lane_img):
    ...
    pts1 = np.float32([[255,114],[0, 146],[510,114],[800, 148]])
